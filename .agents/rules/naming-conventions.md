...
Maintain consistency with the existing MEFS codebase naming patterns.
...
## 2. Functions
- Public API functions declared in headers: `<component>_<verb>_<object>` or similar clear style: e.g., `compute_psf`, `write_fits_complex`.
